...
Puedes tener una o más variables independientes que se utilizan para predecir la variable dependiente binaria. Estas variables pueden ser continuas o categóricas.

</br>

### <span style="color:#034a94">**Función Logit**</span>: 

La función logit es la función de enlace utilizada en la regresión logística. Transforma la probabilidad de éxito en una forma que abarca todo el rango real (-∞, ∞). La función logit se define como el logaritmo natural (ln) de la razón de la probabilidad de éxito a la probabilidad de fracaso.
...
### <span style="color:#034a94">**Hipótesis Nula y Alternativa**</span>: 
