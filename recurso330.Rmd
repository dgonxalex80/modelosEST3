...
<div class="content-box-blue">
$$
\text{Exactitud} = \dfrac{\text{no aciertos en clasificación}}{\text{Total}} = \dfrac{FP + FN}{\text{Total}} = \dfrac{23+57}{400} = 0.20
$$
...
Como se ha indicado la capacidad que tiene el modelo para distinguir entre dos grupos ( matricila de honor/ sin matriculade honor;  no paga/ paga; compra/no compra..) en función de la probabilidad estimada se valora a través de la matriz de confusión, a parir de la cual se construye varios indicadores, la curva ROC (Receiver Operating Characteristic, o Característica Operativa del Receptor)
y el indicador AUC (area under the curve o área bajo la curva ROC)
...
El mejor valor ocurre cuando la tasa de positivos verdaderos (TPR) es 1 y la tasa de falsos positivos (FPR) es cero, caso que se denomina perfecta clasificación.  
