...
$$
\text{Exactitud} = \dfrac{\text{aciertos en clasificación}}{\text{total de  observaciones}} = \dfrac{a+d}{a+b+c+d}
...
$$
TPR = \dfrac{\text{número de positivos correctamente pronosticados}}{\text{número de positivos reales totales}} = \dfrac{a}{a+c}
$$
...
$$
FPR = \dfrac{\text{número de falsos positivos}}{\text{número de negativos reales totales}} = \dfrac{d}{b+d}
$$
